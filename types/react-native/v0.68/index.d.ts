...
//                 Cédric Guérin <https://github.com/guericed>
...
type AccessibilityAnnouncementOptions = {
    queue: boolean;
}
...
export interface AccessibilityInfoStatic {
    ...
    /**
     * Post a string to be announced by the screen reader depending on given options.
     */
    announceForAccessibilityWithOptions: (announcement: string, options: AccessibilityAnnouncementOptions) => void;
